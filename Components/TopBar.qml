...
PanelWindow {
    ...
    // Aliases al WeatherProvider (instance lives in Weather widget) Weather widget already has its own
    // WeatherProvider; no duplicate here. TopBar only needs to relay clicks to the modal.
